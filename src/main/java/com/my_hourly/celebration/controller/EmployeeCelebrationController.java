...
public class EmployeeCelebrationController {
    ...
    public ResponseEntity<ApiResponse> likePost(@PathVariable Long postId, @RequestParam Long employeeId) {
        return celebrationService.likePost(postId, employeeId);
    }

    @DeleteMapping("/{postId}/like")
    public ResponseEntity<ApiResponse> unlikePost(@PathVariable Long postId, @RequestParam Long employeeId) {
        return celebrationService.unlikePost(postId, employeeId);
    }
