...
@AllArgsConstructor
@Builder
@Schema(description = "Request to regenerate a payroll. All fields are optional; a null field keeps the old payroll value.")
public class RegeneratePayrollRequest {
