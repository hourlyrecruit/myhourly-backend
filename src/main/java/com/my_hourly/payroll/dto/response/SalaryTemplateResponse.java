...
public class SalaryTemplateResponse {
    ...
    @Schema(description = "Basic Salary", example = "15000.00")
    private BigDecimal basicSalary;

    @Schema(description = "House Rent Allowance", example = "0.00")
    private BigDecimal hra;

    @Schema(description = "Special Allowance", example = "0.00")
    private BigDecimal specialAllowance;

//    //added after the salary slip, obtained
//    @Schema(description = "Conveyance Allowance", example = "0.00")
//    private BigDecimal conveyance;
//
//    //added after the salary slip, obtained
//    @Schema(description = "Relocation Bonus", example = "0.00")
//    private BigDecimal relocationBonus;

    @Schema(description = "Medical Allowance", example = "0.00")
    private BigDecimal medicalAllowance;

    @Schema(description = "Travel Allowance", example = "0.00")
    private BigDecimal travelAllowance;

    @Schema(description = "Bonus", example = "0.00")
    private BigDecimal bonus;

    @Schema(description = "Other Allowance", example = "0.00")
    ...
    @Schema(description = "Gross Salary", example = "25000.00")
    ...
    @Schema(description = "Provident Fund", example = "3000.00")
